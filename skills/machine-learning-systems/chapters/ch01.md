...
\( \underbrace{\frac{D_{\text{vol}}}{\text{BW}}}_{\text{The Data Term}} + \underbrace{\frac{O}{R_{\text{peak}} \cdot \eta_{\text{hw}}}}_{\text{The Compute Term}} + \underbrace{L_{\text{lat}}}_{\text{The Latency Term}} \)
...
\[ O \cdot N \cdot R_{\text{peak}} \cdot \eta_{\text{hw}} \]
...
\[
\tilde{E}_{\text{total}} \approx D_{\text{vol}} \times \tilde{E}_{\text{move}}
\]
...
\[ \underbrace{\text{RoC} = \frac{\Delta\text{Accuracy}}{\Delta\text{Compute Cost}}}_{\text{Return on Compute}} \]
